...
class LibraryController extends GetxController{
  ...
  getLibraryComic(bool isLoadMore) async {
    if(isLoadMore){
    ...
    final userId = dataService.user.value.ID;
    print("usre id of library :${userId}");
    final formData = fd.FormData.fromMap({
      'action': 'abcomics_get_library',
      'user_id' : dataService.user.value.ID,
      'paged': paged,

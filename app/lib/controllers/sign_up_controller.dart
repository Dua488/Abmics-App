  ...
  Future signUpUser() async {
    ...
    try{
      ...
      if(response['user'] != null){
        ...
        dataService.saveUser(strEmail, strPwd);
        final signInResponse = await dataService.requestData(fdSignIn);
        final user = UserModel.fromJson(signInResponse['user']['data']);
